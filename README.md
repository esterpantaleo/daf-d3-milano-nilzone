A draft visualization to test the geojson files of the neighborhood files of Milan (NILs) on top of a mapbox, made for the (Digital Transformation Team](https://teamdigitale.governo.it/en/) using d3.js.
